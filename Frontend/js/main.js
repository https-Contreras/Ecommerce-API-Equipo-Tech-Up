...
async function cargarContadorCarrito() {
    ...
    try {
        const response = await fetch('https://tech-up.westus2.cloudapp.azure.com/api/cart', {
            method: 'GET',
            headers: {
...
async function cargarProductos(filtros = {}) {
    ...
    try {
        const url = new URL('https://tech-up.westus2.cloudapp.azure.com/tech-up/api/products');
...
async function agregarAlCarritoDesdeProductos(productId, cantidad = 1) {
    ...
    try {
        const response = await fetch('https://tech-up.westus2.cloudapp.azure.com/api/cart/add', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
